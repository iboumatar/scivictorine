    ...
    <main>
      ...
      <section style={{position:'relative',height:'clamp(280px, 60vh, 440px)',overflow:'hidden'}}>
        ...
        <div style={{position:'relative',zIndex:2,height:'100%',display:'flex',flexDirection:'column',justifyContent:'center',padding:'clamp(1rem, 5vw, 4rem)'}}>
          ...
          <h1 style={{fontSize:'clamp(28px, 8vw, 58px)',fontWeight:'900',color:'#fff',lineHeight:'1.1',marginBottom:'12px',textShadow:'0 2px 12px rgba(0,0,0,0.8)'}}>Nos <span style={{color:'#e74c3c'}}>Services</span></h1>
          <p style={{fontSize:'clamp(16px, 4vw, 20px)',color:'#fff',maxWidth:'500px',lineHeight:'1.8',textShadow:'0 1px 6px rgba(0,0,0,0.9)'}}>Des solutions immobilières complètes et personnalisées pour tous vos projets au Sénégal.</p>
        </div>
      </section>
      ...
      <div style={{
        ...
        {['Construction','Appartements','Terrains & Lotissement','Financement','Fiscal','Conseil juridique'].map((item,i)=>(
          <a key={i} href={`#service-${i+1}`} style={{
            padding:'clamp(0.8rem, 1.5vw, 1.2rem) clamp(0.8rem, 2vw, 1.5rem)',
      ...
      {/* SERVICE 1 */}
      <section id="service-1" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fff'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          <img src="/images/services/construction.jpg" alt="Construction" style={{height:'clamp(250px, 50vw, 340px)',objectFit:'cover',width:'100%'}}/>
          <div>
            <div style={{fontSize:'clamp(48px, 15vw, 96px)',fontWeight:'900',color:'#f5f5f5',lineHeight:1,marginBottom:'-20px'}}>01</div>
            <div style={{fontSize:'14px',letterSpacing:'4px',textTransform:'uppercase',color:'#c0392b',marginBottom:'10px'}}>Notre expertise</div>
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Construction d'immeubles</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
            <p style={{fontSize:'clamp(15px, 3vw, 19px)',color:'#666',lineHeight:'2',marginBottom:'1.2rem'}}>SCI Victorine Immo prend en charge la conception et la réalisation complète de vos projets de construction. De l'étude de faisabilité à la livraison, nous assurons un suivi rigoureux à chaque étape.</p>
      ...
      {/* SERVICE 2 */}
      <section id="service-2" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fafafa'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          <div>
            ...
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Vente d'appartements</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
      ...
      {/* SERVICE 3 */}
      <section id="service-3" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fff'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          <img src="/images/services/terrain.jpg" alt="Terrains & Lotissement" style={{height:'clamp(250px, 50vw, 340px)',objectFit:'cover',width:'100%'}}/>
          <div>
            <div style={{fontSize:'clamp(48px, 15vw, 96px)',fontWeight:'900',color:'#f5f5f5',lineHeight:1,marginBottom:'-20px'}}>03</div>
            <div style={{fontSize:'14px',letterSpacing:'4px',textTransform:'uppercase',color:'#c0392b',marginBottom:'10px'}}>Foncier & Aménagement</div>
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Terrains & Lotissement</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
            <p style={{fontSize:'clamp(15px, 3vw, 19px)',color:'#666',lineHeight:'2',marginBottom:'1.2rem'}}>Nous disposons d'un large portefeuille de terrains viabilisés dans les zones à fort potentiel de croissance au Sénégal, et réalisons des opérations de lotissement conformes aux normes urbanistiques en vigueur, de l'acquisition foncière à la viabilisation des lots.</p>
      ...
      {/* SERVICE 4 */}
      <section id="service-4" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fafafa'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          <div>
            ...
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Recherche de financement</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
            <p style={{fontSize:'clamp(15px, 3vw, 19px)',color:'#666',lineHeight:'2',marginBottom:'1.2rem'}}>Nous accompagnons nos clients dans la recherche et le montage de leurs dossiers de financement immobilier. Grâce à notre réseau de partenaires bancaires, nous facilitons l'accès au crédit.</p>
      ...
      {/* SERVICE 5 */}
      <section id="service-5" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fff'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          ...
          <div>
            <div style={{fontSize:'clamp(48px, 15vw, 96px)',fontWeight:'900',color:'#f5f5f5',lineHeight:1,marginBottom:'-20px'}}>05</div>
            <div style={{fontSize:'14px',letterSpacing:'4px',textTransform:'uppercase',color:'#c0392b',marginBottom:'10px'}}>Fiscal</div>
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Encadrement fiscal</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
            <p style={{fontSize:'clamp(15px, 3vw, 19px)',color:'#666',lineHeight:'2',marginBottom:'1.2rem'}}>Notre service d'encadrement fiscal vous accompagne dans la gestion et l'optimisation fiscale de vos investissements immobiliers. Nous vous aidons à comprendre et respecter vos obligations fiscales.</p>
      ...
      {/* SERVICE 6 */}
      <section id="service-6" style={{padding:'clamp(3rem, 8vw, 5rem) clamp(1rem, 5vw, 4rem)',background:'#fafafa'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',gap:'clamp(2rem, 5vw, 4rem)',alignItems:'center'}}>
          <div>
            ...
            <h2 style={{fontSize:'clamp(22px, 5vw, 34px)',fontWeight:'900',color:'#1a1a1a',marginBottom:'16px'}}>Conseil et veille juridique</h2>
            <div style={{width:'40px',height:'2px',background:'#c0392b',marginBottom:'20px'}}/>
            <p style={{fontSize:'clamp(15px, 3vw, 19px)',color:'#666',lineHeight:'2',marginBottom:'1.2rem'}}>Notre service de conseil juridique accompagne vos opérations immobilières à chaque étape, en assurant un suivi réglementaire rigoureux et une veille juridique constante.</p>
      ...
      <section style={{background:'#c0392b',padding:'clamp(2rem, 6vw, 4rem)',textAlign:'center'}}>
        <h2 style={{fontSize:'clamp(24px, 6vw, 34px)',fontWeight:'900',color:'#fff',marginBottom:'12px'}}>Vous avez un projet immobilier ?</h2>
        <p style={{fontSize:'clamp(16px, 3.5vw, 19px)',color:'rgba(255,255,255,0.75)',marginBottom:'2rem'}}>Contactez-nous pour un accompagnement personnalisé et gratuit.</p>
